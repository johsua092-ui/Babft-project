...
export const gateDefinitions: GateDefinition[] = [
  {
    ...
    label: "Basic Wire",
    color: "#60a5fa",
    description: "Output follows the input exactly.",
    rule: "OUT = A",
    fn: (a) => a,
  },
  {
    ...
    label: "NOT Gate",
    color: "#ef4444",
    description: "Output is the inverted value of the input.",
    rule: "OUT = NOT A",
    fn: (a) => !a,
  },
  {
  ...
  },
  {
    ...
    label: "XOR Gate",
    color: "#14b8a6",
    description: "Output is 1 when the inputs are different.",
    rule: "OUT = A XOR B",
    fn: (a, b) => a !== b,
  },
  {
    ...
    label: "XNOR Gate",
    color: "#eab308",
    description: "Output is 1 when the inputs are the same.",
